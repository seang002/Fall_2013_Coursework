...
# Author:  Modifications made for Lab 8 by Dan Shea
#
...
my $outputfilename = ask_user("Filename", "query.out");

# ---------------------------------------------------------------------------
# $outputfilename is where query results will be printed out to a file
# Here we open the file for output or die trying! (We're hardcore man!)
open(my $fh, ">", $outputfilename) or die("Failed to open $outputfilename for writing. $!");
...
print $fh "Count = $Count; QueryKey = $QueryKey; WebEnv = $WebEnv\n";
