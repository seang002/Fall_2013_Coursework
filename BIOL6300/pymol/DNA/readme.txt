This directory contains coordinate files and pymol script files for studying basic DNA structure. The script will only work after you download and install the program Pymol.
...
Once file.pml and file.pdb are associated with Pymol, then double click on dna.pml.
